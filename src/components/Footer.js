...
function Footer() {
    return (
        <div className='footer'>
            <div><svg class="book-shelf" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 84 94" height="94" width="84">
            ...
            <a target="_blank" href="https://www.careeronestop.org/LocalHelp/CommunityServices/find-libraries.aspx">Click here</a>
            <span> to find your local library</span>
        </div>
    )
}
